...
XorDynamicEncoderX64ChaCha* xor_dynamic_encoder_x64_chacha_new(uint64_t seed, bool plain_decoder, uint32_t encoding_count, bool save_registers, const uint8_t* badchars, size_t badchars_len);
...
XorDynamicEncoderX64Thread* xor_dynamic_encoder_x64_thread_new(bool plain_decoder, uint32_t encoding_count, bool save_registers, const uint8_t* badchars, size_t badchars_len);
