...
SgnEncoderX64ChaCha* sgn_encoder_x64_chacha_new(uint8_t seed, bool plain_decoder, uint32_t encoding_count, bool save_registers, bool ascii_printable, const uint8_t* badchars, size_t badchars_len);
...
SgnEncoderX64ThreadRng* sgn_encoder_x64_thread_new(bool plain_decoder, uint32_t encoding_count, bool save_registers, bool ascii_printable, const uint8_t* badchars, size_t badchars_len);
...
// X32 SGN Encoder
SgnEncoderX32* sgn_encoder_x32_new(bool plain_decoder, uint32_t encoding_count, bool save_registers, bool ascii_printable, const uint8_t* badchars, size_t badchars_len);
