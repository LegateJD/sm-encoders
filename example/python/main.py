from ranis import SgnEncoderX64ChaCha, XorDynamicEncoderX64ThreadRng
...
sgn = SgnEncoderX64ChaCha(seed=1234, encoding_count=2)
sgn_payload = sgn.encode(SHELLCODE)
show("SGN (chacha, deterministic)", SHELLCODE, sgn_payload)

# XOR Dynamic: lighter-weight encoder, here using the OS thread RNG
# (non-deterministic).
xor = XorDynamicEncoderX64ThreadRng()
